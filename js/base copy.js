...
document.getElementById("loading-text").innerHTML = "Downloading WHO Information... (This may take a minute)"
bar.set(20)
...
function getWhoData(whoType){
    ...
    xmlHttp.open("GET", "https://cors-anywhere.herokuapp.com/apps.who.int/gho/athena/api/GHO/" + whoType + "?format=json&profile=simple", false );
